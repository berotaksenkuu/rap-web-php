...
$query = mysqli_query($koneksi, "SELECT * FROM sepeda WHERE id='$id'");
...
<body class="bg-light">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 detail-col p-5">
                    <h2 class="text-center mb-4">Edit Sepeda</h2>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <a href="sepeda.php" class="btn btn-secondary">Kembali</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    if (isset($_POST['editBtn'])) {
        ...
        $query = mysqli_query($koneksi, "UPDATE sepeda SET 
                                       merk='$merk', 
                                       harga='$harga', 
                                       jumlah='$jumlah' 
                                       WHERE id='$id'");
    ...
    if (isset($_POST['hapusBtn'])) {
        ...
        $query = mysqli_query($koneksi, "DELETE FROM sepeda WHERE id='$id'");
