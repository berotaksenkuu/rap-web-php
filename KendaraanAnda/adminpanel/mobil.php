...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex align-items-center mb-3">
            ...
            <span>
                <li class="fas fa-car"></li> Mobil
            </span>
        </div>

        <div class="card mb-4">
            <div class="card-body">
                <h5 class="card-title mb-4">Tambah Mobil</h5>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-4">Mobil</h5>
                <table class="table">
                    <thead>
                        <tr>
                            <th>No.</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="mobil-detail.php?p=<?php echo $data['id']; ?>"
    ...
    if (isset($_POST['simpan'])) {
        ...
        if (move_uploaded_file($tmp, "../img/" . $nama_file)) {
            $query = mysqli_query($koneksi, "INSERT INTO mobil (merk, harga, jumlah, gambar) 
