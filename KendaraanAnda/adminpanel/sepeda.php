...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex align-items-center mb-3">
            ...
            <span>
                <li class="fas fa-bicycle"></li> Sepeda
            </span>
        </div>

        <div class="card mb-4">
            <div class="card-body">
                <h5 class="card-title mb-4">Tambah Sepeda</h5>
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-4">Sepeda</h5>
                <table class="table">
                    <thead>
                        <tr>
                            <th>No.</th>
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $query = mysqli_query($koneksi, "SELECT * FROM sepeda");
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="sepeda-detail.php?p=<?php echo $data['id']; ?>"
    ...
    if (isset($_POST['simpan'])) {
        ...
        if (move_uploaded_file($tmp, "../img/" . $nama_file)) {
            $query = mysqli_query($koneksi, "INSERT INTO sepeda (merk, harga, jumlah, gambar) 
