...
<body>
    ...
    <div class="container mt-5">
        <h1 class="page-title">Kategori Sepeda</h1>
        <div class="row">
            <?php
                ...
                <div class="col-md-4">
                    <div class="car-card">
                        ...
                        <div class="text-center">
                            ...
                            <a href="pesanan.php?jenis=Sepeda&merk=<?php echo urlencode($data['merk']); ?>&harga=<?php echo $data['harga']; ?>&gambar=<?php echo urlencode($data['merk']); ?>.png"
