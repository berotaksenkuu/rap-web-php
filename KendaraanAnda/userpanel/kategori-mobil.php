...
<body>
    ...
    <div class="container mt-5">
        <h1 class="page-title">Kategori Mobil</h1>
        <div class="row">
            <?php
                ...
                <div class="col-md-4">
                    <div class="car-card">
                        ...
                        <div class="text-center">
                            ...
                            <a href="pesanan.php?jenis=Mobil&merk=<?php echo urlencode($data['merk']); ?>&harga=<?php echo $data['harga']; ?>&gambar=<?php echo urlencode($data['merk']); ?>.png"
